...
int main(void)
{
  ...
  TIMER0->CTRL &= 0xF0FFFFFF;
  TIMER0->CTRL |= 0x09000000;


  while (1)
  {
	  if((TIMER0->STATUS & 0x2) == 0x2)
	  {
		  LedController(0, true);
		  LedController(1, true);
	  }
	  else if((TIMER0->STATUS & 0x2) == 0x0)
	  {
		  LedController(0, false);
		  LedController(1, false);
	  }
  }
}
